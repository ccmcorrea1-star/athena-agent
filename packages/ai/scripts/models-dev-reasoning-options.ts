...
/**
 * Converts models.dev verified effort values into Athena's selectable thinking levels.
 * Values without an Athena equivalent (`default` and JSON `null`) are intentionally
 * omitted.
 */

...
// OpenAI Responses rejects max_output_tokens below 16: https://github.com/earendil-works/athena-agent/issues/6265
 ...
 * Defaults to "short" and uses ATHENA_CACHE_RETENTION for backward compatibility.
 */
function resolveCacheRetention(cacheRetention?: CacheRetention, env?: ProviderEnv): CacheRetention {
	if (cacheRetention) {
		return cacheRetention;
	}
	if (getProviderEnvValue("ATHENA_CACHE_RETENTION", env) === "long") {
		return "long";
	}
	return "short";
}

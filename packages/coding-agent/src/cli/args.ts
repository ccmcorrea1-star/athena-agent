...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self|athena]   Update athena, extensions, or model catalogs
...
${chalk.bold("Options:")}
  ...
  --offline                      Disable startup network operations (same as ATHENA_OFFLINE=1)
...
${chalk.bold("Environment Variables:")}
  ...
  ATHENA_SHARE_VIEWER_URL              - Base URL for /share command (default: https://athena.dev/session/)

...
import type { AssistantMessage, Model } from "@athena/ai";
...
vi.mock("@athena/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@athena/ai/compat")>();
	return {
		...actual,

...
import { Text, type TUI } from "@athena/tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".athena", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .athena/AGENTS.md",
	...
	for (const scenario of [
		...
		{ title: "Athena documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {

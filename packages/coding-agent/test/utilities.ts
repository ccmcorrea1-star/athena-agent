...
import type { OAuthCredentials } from "@athena/ai";
import { getModel, streamSimple } from "@athena/ai/compat";
import { builtinProviders } from "@athena/ai/providers/all";
...
// ============================================================================
// OAuth API key resolution from ~/.athena/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".athena", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.athena/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.athena/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".athena", "agent");

/**
 * Get an AuthStorage instance backed by ~/.athena/agent/auth.json
